...
class BookingApi {
  ...
  Future<Response<JsonObject>> bookingBookingScraperHealthCheck({ 
    ...
    final _path = r'/v1/booking/health';
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bookingBookingScraperHealthCheckHead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [photos] - Gallery photos to return
  /// * [questions] - Guest Q&A pairs to return
  /// * [language] - Locale, e.g. en-us, fr
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bookingGetPropertyDetail({ 
    ...
    final _path = r'/v1/booking/properties/{country_code}/{slug}'.replaceAll('{' r'country_code' '}', encodeQueryParameter(_serializers, countryCode, const FullType(String)).toString()).replaceAll('{' r'slug' '}', encodeQueryParameter(_serializers, slug, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (photos != null) r'photos': encodeQueryParameter(_serializers, photos, const FullType(int)),
      if (questions != null) r'questions': encodeQueryParameter(_serializers, questions, const FullType(int)),
  ...
  /// * [limit] 
  /// * [offset] 
  /// * [sort] - MOST_RELEVANT | NEWEST_FIRST | OLDEST_FIRST | SCORE_DESC | SCORE_ASC
  /// * [reviewLanguage] - Only reviews written in this language, e.g. 'fr'
  /// * [guestType] - FAMILIES | COUPLES | GROUP_OF_FRIENDS | SOLO_TRAVELLERS | BUSINESS_TRAVELLERS
  /// * [language] - Locale for labels, e.g. en-us
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bookingGetPropertyReviews({ 
    required String countryCode,
    required String slug,
    int? limit = 25,
    int? offset = 0,
    ...
    final _path = r'/v1/booking/properties/{country_code}/{slug}/reviews'.replaceAll('{' r'country_code' '}', encodeQueryParameter(_serializers, countryCode, const FullType(String)).toString()).replaceAll('{' r'slug' '}', encodeQueryParameter(_serializers, slug, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'review_language': encodeQueryParameter(_serializers, reviewLanguage, const FullType(String)),
      r'guest_type': encodeQueryParameter(_serializers, guestType, const FullType(String)),
      r'language': encodeQueryParameter(_serializers, language, const FullType(String)),
    };
  ...
  ///
  /// Parameters:
  /// * [query] - Free-text place, e.g. 'amsterd'
  /// * [limit] 
  /// * [language] - Locale, e.g. en-us, fr
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bookingSearchDestinations({ 
    ...
    final _path = r'/v1/booking/destinations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [location] - Free-text destination, e.g. 'Rome'
  /// * [destId] - Exact destination id (ufi) from /destinations
  /// * [destType] - Destination type, e.g. CITY
  /// * [checkin] - Check-in date YYYY-MM-DD
  /// * [checkout] - Check-out date YYYY-MM-DD
  /// * [adults] 
  /// * [children] - Comma-separated children ages, e.g. '4,9'
  ...
  /// * [limit] 
  /// * [sort] - popularity | price | class_descending | class_ascending | distance_from_search | bayesian_review_score | review_score_and_price | upsort_bh
  /// * [filters] - Semicolon-separated Booking filter ids, e.g. 'class=4'
  /// * [currency] - ISO currency, e.g. EUR, USD, GBP
  /// * [language] - Locale, e.g. en-us, fr, de, es
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bookingSearchProperties({ 
    String? location,
    int? destId,
    String? destType = 'NO_DEST_TYPE',
    String? checkin,
    String? checkout,
    int? adults = 2,
    String? children,
    ...
    final _path = r'/v1/booking/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'dest_id': encodeQueryParameter(_serializers, destId, const FullType(int)),
      if (destType != null) r'dest_type': encodeQueryParameter(_serializers, destType, const FullType(String)),
      r'checkin': encodeQueryParameter(_serializers, checkin, const FullType(String)),
      r'checkout': encodeQueryParameter(_serializers, checkout, const FullType(String)),
      if (adults != null) r'adults': encodeQueryParameter(_serializers, adults, const FullType(int)),
      r'children': encodeQueryParameter(_serializers, children, const FullType(String)),
      ...
      r'filters': encodeQueryParameter(_serializers, filters, const FullType(String)),
      r'currency': encodeQueryParameter(_serializers, currency, const FullType(String)),
      r'language': encodeQueryParameter(_serializers, language, const FullType(String)),
    };
