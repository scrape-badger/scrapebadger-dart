...
class BingApi {
  ...
  const BingApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> bingBingScraperHealthCheck({ 
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingBingScraperHealthCheckHead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingImageSearch({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'safe_search': encodeQueryParameter(_serializers, safeSearch, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingListSupportedMarkets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  ///
  /// Parameters:
  /// * [query] - Search keywords, e.g. 'interest rates'
  /// * [market] - Bing market code, e.g. 'en-US', 'en-GB', 'de-DE'. See /markets.
  /// * [freshness] - day | week | month — restrict to recent articles
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingNewsSearch({ 
    required String query,
    String? market = 'en-US',
    String? freshness,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      r'query': encodeQueryParameter(_serializers, query, const FullType(String)),
      if (market != null) r'market': encodeQueryParameter(_serializers, market, const FullType(String)),
      r'freshness': encodeQueryParameter(_serializers, freshness, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingSearchSuggestions({ 
    required String query,
    String? market = 'en-US',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/bing/autocomplete';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [query] - Search keywords, e.g. 'espresso tutorial'
  /// * [market] - Bing market code, e.g. 'en-US', 'en-GB', 'de-DE'. See /markets.
  /// * [count] - Results to return
  /// * [safeSearch] - off | moderate | strict
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingVideoSearch({ 
    required String query,
    String? market = 'en-US',
    int? count = 35,
    String? safeSearch,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> bingWebSearch({ 
    required String query,
    String? market = 'en-US',
    int? count = 10,
    int? offset = 0,
