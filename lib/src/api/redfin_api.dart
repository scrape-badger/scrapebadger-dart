...
class RedfinApi {
  ...
  const RedfinApi(this._dio, this._serializers);

  /// Get agent profile + listings
  /// Get a Redfin real-estate agent&#39;s profile and their active listings.
  ///
  /// Parameters:
  /// * [url] - Full Redfin /realestateagents/ URL
  /// * [agentId] - Redfin agent id
  ...
  Future<Response<JsonObject>> redfinGetAgentProfileListings({ 
    String? url,
    String? agentId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'agent_id': encodeQueryParameter(_serializers, agentId, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinGetPropertyDetail({ 
    ...
    final _path = r'/v1/redfin/property/{property_id}'.replaceAll('{' r'property_id' '}', encodeQueryParameter(_serializers, propertyId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [url] - Full Redfin property URL (/CA/City/.../home/12345678)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinGetPropertyDetailByUrl({ 
    required String url,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/redfin/property';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinListCoverageMarkets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/redfin/markets';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinRedfinScraperHealthCheck({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/redfin/health';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinRedfinScraperHealthCheckHead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinRegionAddressSuggestions({ 
    ...
    final _path = r'/v1/redfin/autocomplete';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [page] 
  /// * [sort] - relevant|newest|price_high_to_low|price_low_to_high|square_feet|lot_size|price_per_sqft|beds|baths
  /// * [priceMin] 
  /// * [priceMax] 
  /// * [bedsMin] 
  /// * [bathsMin] 
  /// * [homeType] - house|condo|townhouse|multi_family|land|mobile|coop|other
  /// * [sqftMin] 
  /// * [sqftMax] 
  /// * [lotMin] 
  /// * [lotMax] 
  ...
  /// * [yearBuiltMax] 
  /// * [maxDaysOnMarket] 
  /// * [north] - Map bounds for tiling past the cap
  /// * [south] 
  /// * [east] 
  /// * [west] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> redfinSearchProperties({ 
    ...
    final _path = r'/v1/redfin/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'max_days_on_market': encodeQueryParameter(_serializers, maxDaysOnMarket, const FullType(int)),
