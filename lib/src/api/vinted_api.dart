...
class VintedApi {
  ...
  const VintedApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> vintedGetItemDetails({ 
    ...
    final _path = r'/v1/vinted/items/{item_id}'.replaceAll('{' r'item_id' '}', encodeQueryParameter(_serializers, itemId, const FullType(int)).toString());
  ...
  Future<Response<JsonObject>> vintedGetUserProfile({ 
    ...
    final _path = r'/v1/vinted/users/{user_id}'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedGetUserSListedItems({ 
    ...
    final _path = r'/v1/vinted/users/{user_id}/items'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedListColors({ 
    ...
    final _path = r'/v1/vinted/colors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedListItemConditions({ 
    ...
    final _path = r'/v1/vinted/statuses';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedListMarkets({ 
    ...
    final _path = r'/v1/vinted/markets';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedSearchBrands({ 
    ...
    final _path = r'/v1/vinted/brands';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> vintedSearchByImage({ 
    ...
    final _path = r'/v1/vinted/search_by_image';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(VintedImageSearchRequest);
      _bodyData = _serializers.serialize(vintedImageSearchRequest, specifiedType: _type);
  ...
  Future<Response<JsonObject>> vintedSearchVintedItems({ 
    ...
    final _path = r'/v1/vinted/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (market != null) r'market': encodeQueryParameter(_serializers, market, const FullType(String)),
      r'seller_country': encodeQueryParameter(_serializers, sellerCountry, const FullType(String)),
      if (page != null) r'page': encodeQueryParameter(_serializers, page, const FullType(int)),
      if (perPage != null) r'per_page': encodeQueryParameter(_serializers, perPage, const FullType(int)),
      r'price_from': encodeQueryParameter(_serializers, priceFrom, const FullType(num)),
      r'price_to': encodeQueryParameter(_serializers, priceTo, const FullType(num)),
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> vintedVintedScraperHealthCheck({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/vinted/health';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> vintedVintedScraperHealthCheckHead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
