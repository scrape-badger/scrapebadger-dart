...
class EBayApi {
  ...
  const EBayApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> ebayBrowseACategory({ 
    ...
    final _path = r'/v1/ebay/categories/{category_id}/items'.replaceAll('{' r'category_id' '}', encodeQueryParameter(_serializers, categoryId, const FullType(String)).toString());
  ...
  Future<Response<JsonObject>> ebayCompletedSoldListings({ 
    ...
    final _path = r'/v1/ebay/completed';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayEbayScraperHealthCheck({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayEbayScraperHealthCheckHead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayGetItemDetail({ 
    ...
    final _path = r'/v1/ebay/items/{item_id}'.replaceAll('{' r'item_id' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayGetItemReviews({ 
    required String itemId,
    String? domain = 'com',
    int? page = 1,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/ebay/items/{item_id}/reviews'.replaceAll('{' r'item_id' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayGetSellerFeedback({ 
    ...
    final _path = r'/v1/ebay/sellers/{username}/feedback'.replaceAll('{' r'username' '}', encodeQueryParameter(_serializers, username, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayGetSellerListings({ 
    required String username,
    String? domain = 'com',
    String? query,
    int? page = 1,
    ...
    final _path = r'/v1/ebay/sellers/{username}/items'.replaceAll('{' r'username' '}', encodeQueryParameter(_serializers, username, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayGetSellerProfile({ 
    required String username,
    String? domain = 'com',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/ebay/sellers/{username}'.replaceAll('{' r'username' '}', encodeQueryParameter(_serializers, username, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayKeywordSuggestions({ 
    required String query,
    String? domain = 'com',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/ebay/autocomplete';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayListCategories({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/ebay/categories';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebayListMarkets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebaySearchByImage({ 
    ...
    final _path = r'/v1/ebay/search/by-image';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> ebaySearchListings({ 
    required String query,
    String? domain = 'com',
    String? categoryId,
    int? page = 1,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (sortBy != null) r'sort_by': encodeQueryParameter(_serializers, sortBy, const FullType(String)),
      r'condition': encodeQueryParameter(_serializers, condition, const FullType(String)),
      r'buying_format': encodeQueryParameter(_serializers, buyingFormat, const FullType(String)),
      r'min_price': encodeQueryParameter(_serializers, minPrice, const FullType(num)),
      r'max_price': encodeQueryParameter(_serializers, maxPrice, const FullType(num)),
